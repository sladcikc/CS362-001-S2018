   ...
   /**
	...
	//			System.out.println(" Seed:"+randomseed );
				Random random = new Random(randomseed);
				 ...
				 int sDays=ValuesGenerator.getRandomIntBetween(random, -1, 32);
				 int sMonths=ValuesGenerator.getRandomIntBetween(random, -1, 13);
				 int sYears=ValuesGenerator.getRandomIntBetween(random, -2, 100);
				 day2.set(sYears, sMonths, sDays);
				 CalDay calday = new CalDay(day);
				 
				  DataHandler dh = new DataHandler("file", true);
				 
				 for (int i = 0; i < NUM_TESTSs/2; i++) {
